...
public class Wordle2 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			// 4. PARTIDA PERDIDA
			if (!resultado.equals(correcto) || nwrong >=2) {
				...
				boolean fin=false;
				 do{
				  char a = palabra.charAt(cont);
				  if (presente(letras1, a)  || palabra2[cont]==a) {
				  System.out.println("Has hecho trampas >:c\n¡He ganado!");
						partidasGanadas++;
						fin =true;
				  }
				  else if (palabra2[cont]==a) {
				  System.out.println("Has hecho trampas >:c\n¡He ganado!");
						partidasGanadas++;
						fin = true;
				  }
				  else if (presente(letras0, a)) {
				  System.out.println("Has hecho trampas >:c\n¡He ganado!");
						partidasGanadas++;
						fin =true;
				  }
				  cont ++;
				  }while(cont< nLetras && !fin );
